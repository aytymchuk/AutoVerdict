...
file sealed record SuccessCommand : IRequest<Result<string>>;
file sealed record FailureCommand : IRequest<Result<string>>;
file sealed record ThrowingCommand : IRequest<Result<string>>;
